...
var types = {
    text: ["date", "datetime-local", "email", "hidden", "month", "number", "password", "search", "tel", "text", "time", "week"]
};

var Input = _styledComponents2.default.input(_templateObject, function (props) {
    return types.text.includes(props.type) && (0, _styledComponents.css)(_templateObject2, function (props) {
        return props.expanded ? "100%" : "10em";
    }, function (props) {
        return props.theme.sizes[props.size];
    }, function (props) {
        return props.theme.radius;
        ...
        return props.theme.sizes[props.size] / 4;
    }, function (props) {
        return props.expanded || props.align == "right" ? 0 : "0.4em";
    }, function (props) {
        return props.align == "right" ? "0.4em" : 0;
...
var _animateCssStyledComponents = __webpack_require__(4);
...
Modal = (0, _styledComponents.withTheme)(Modal);
...
var Row = _styledComponents2.default.div(_templateObject, function (props) {
    return props.expanded ? "100%" : props.width + "px";
});
...
var _reactLoading = __webpack_require__(24);
...
var LoadingIcon = function LoadingIcon(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            LoadingInner,
            null,
            _react2.default.createElement(_reactLoading2.default, {
                type: props.type,
                color: props.color,
                width: "100%",
                height: "100%"
...
var _blank = __webpack_require__(27);
...
var _loadingBalls = __webpack_require__(28);
...
var _loadingBars = __webpack_require__(29);
...
var _loadingBubbles = __webpack_require__(30);
...
var _loadingCubes = __webpack_require__(31);
...
var _loadingCylon = __webpack_require__(32);
...
var _loadingSpin = __webpack_require__(33);
...
var _loadingSpinningBubbles = __webpack_require__(34);
...
var _loadingSpokes = __webpack_require__(35);
  ...
  _createClass(Loading, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          restProps = _objectWithoutProperties(_props, ['color', 'delay', 'type', 'height', 'width', 'className']);
